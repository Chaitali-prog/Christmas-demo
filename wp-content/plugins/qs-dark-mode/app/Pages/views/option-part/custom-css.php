...
<?php $switch_settings = $this->custom_css_options(); ?>
    ...
    <?php foreach($switch_settings as $item_key => $item): ?>
                    ...
                    <div class="qs-dark-mode-block-col qs-dark-mode-block-col-xl-3 qs-dark-mode-block-col-lg-4 qs-dark-mode-block-col-md-6">
                        <div class="quomodo_switch_common qs-dark-mode-common <?php echo esc_attr($item['is_pro']?'qs-dark-mode-pro qs-dark-mode-dash-modal-open-btn':''); ?>">
                            <div class="quomodo_sm_switch">
                                ...
                                <input <?php echo esc_attr( $item[ 'is_pro' ]?'readonly disabled':''); ?> <?php echo esc_attr( $item[ 'default' ]==1?'checked':''); ?> name="qs-dark-mode-custom-css-option[<?php echo esc_attr( $item_key ); ?>]" class="quomodo_switch <?php echo esc_attr( $item_key ); ?>" id="quomodo-modules-<?php echo esc_attr( $item_key ); ?>" type="checkbox">
                    ...
                    <div class="qs-dark-mode-block-image-wrapper-list">
                        <?php foreach( $item['options'] as $img_option ): ?>
                            <div class="qs-dark-mode-img-block-wrapper"> 
                                <input <?php echo esc_attr($img_option['value'] == $item['value']?'checked':''); ?> id="<?php echo esc_attr($item_key.'_'.$img_option['value']); ?>" type="radio" name="qs-dark-mode-custom-css-option[<?php echo esc_attr( $item_key ); ?>]" value="<?php echo esc_attr($img_option['value']); ?>"  />
        ...
        <?php if( $item['type'] == 'select' ): ?>
            ...
            <div class="qs-dark-mode-select-list-wrapper">
                <div class="qs-dark-mode-select-list-inner-wrapper"> 
                   <select  class="qs-dark-mode-select-dropdown" name="qs-dark-mode-custom-css-option[<?php echo esc_attr( $item_key ); ?>]"> 
        ...
        <?php if( $item['type'] == 'select2' ): ?>
           <div class="qs-dark-mode-custom-css-wrapper">
                ...
                <div class="qs-dark-mode-select-list-wrapper">
                    <div class="qs-dark-mode-select-list-inner-wrapper <?php echo esc_attr($item['is_pro']?'qs-pro':''); ?>"> 
                        <select multiple="multiple" class="qs-dark-mode-select-dropdown js-qs-dark-mode-select2-single" name="qs-dark-mode-custom-css-option[<?php echo esc_attr( $item_key ); ?>][]"> 
                                <?php foreach($item['options'] as $select_key => $select_option): ?>
            ...
            <div class="qs-dark-mode-elements-wrapper">
                ...
                <div class="qs-dark-mode-textarea-wrapper">
                    <div class="qs-dark-mode-textarea-inner-wrapper"> 
                        <textarea  name="qs-dark-mode-custom-css-option[<?php echo esc_attr( $item_key ); ?>]" class="qs-dark-mode-textarea-option" cols="10" rows="10"><?php echo trim(esc_html(isset($item['value']) && $item['value'] !=''?$item['value']:'')); ?></textarea>
